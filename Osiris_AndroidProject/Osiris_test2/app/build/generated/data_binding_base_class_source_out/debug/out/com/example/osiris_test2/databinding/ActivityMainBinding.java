...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton fabNewTest;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton fabNewTest, @NonNull RoundedImageView imageProfile,
      @NonNull AppCompatImageView imageSignOut, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView testRecyclerView, @NonNull TextView textErrorMessage,
      @NonNull TextView textName) {
    this.rootView = rootView;
    this.fabNewTest = fabNewTest;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fabNewTest;
      FloatingActionButton fabNewTest = ViewBindings.findChildViewById(rootView, id);
      if (fabNewTest == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, fabNewTest, imageProfile,
          imageSignOut, progressBar, testRecyclerView, textErrorMessage, textName);
    }
